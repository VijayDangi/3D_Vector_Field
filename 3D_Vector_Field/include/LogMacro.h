#ifndef _SS_GL_LOG_MACRO_H_
#define _SS_GL_LOG_MACRO_H_
...
#define LogDebug(fmt, ...) \
        PrintLog("LogDebug", LOG_CONSOLE_LIGHT_TEXT_GREY_COLOR, LOG_CONSOLE_DARK_BKG_GREY_COLOR, __LINE__, __FILE__, __FUNCTION__, fmt, __VA_ARGS__)
